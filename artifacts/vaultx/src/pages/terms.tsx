...
const DEFAULT_SECTIONS = [
  {
    ...
    content: `To use Wexora, you must register an account with accurate, current, and complete information. You must be at least 18 years old and legally permitted to use investment platforms in your jurisdiction. You are responsible for maintaining the confidentiality of your login credentials. You agree to notify us immediately of any unauthorized access to your account.`,
  },
  {
    title: "Platform Usage",
    content: `Wexora provides a digital investment platform. You agree to use the platform only for lawful purposes and in accordance with these Terms. You may not use the platform in any way that could damage, disable, or impair its operation. We reserve the right to modify or discontinue any feature with reasonable notice.`,
  },
  {
    title: "Deposits",
    content: `All deposits are made in USDT via supported blockchain networks. Minimum deposit amounts apply as configured on the platform. Deposits are credited after sufficient network confirmations. Wexora is not responsible for lost funds sent to incorrect addresses. Always verify wallet addresses before initiating transactions.`,
  },
  {
    title: "Withdrawals",
    content: `Withdrawals are processed within 24 hours of submission, subject to review. Minimum withdrawal amounts and fees apply as displayed. You must ensure your withdrawal address is correct — Wexora cannot reverse completed blockchain transactions. KYC verification may be required before withdrawals are processed.`,
  },
  {
    title: "Opportunities",
    content: `Opportunities on Wexora offer structured returns based on defined durations and ROI rates. Returns are credited as described in each opportunity. Performance depends on plan terms. Past performance is not indicative of future results. You should only allocate funds you can afford to lock for the opportunity duration.`,
  },
  {
    title: "Referral Program",
    content: `Wexora offers a multi-level referral program where you earn commissions when users you refer make deposits or investments. Referral rates are set by the platform and may change. Commissions are credited to your wallet automatically. Fraudulent referral activity including self-referrals or fake accounts will result in immediate account suspension.`,
  },
  {
    title: "Security Responsibilities",
    content: `You are responsible for keeping your account secure. Enable two-factor authentication (2FA) for maximum protection. Do not share your password or 2FA codes with anyone, including Wexora support. We will never ask for your password. Report suspicious activity to support immediately. We are not liable for losses resulting from your failure to maintain account security.`,
  },
  {
    title: "Prohibited Activities",
    content: `You may not use Wexora for money laundering, fraud, or any illegal financial activity. Creating multiple accounts is prohibited. Automated access, bots, or scripts without explicit written permission are prohibited. Attempting to manipulate platform mechanics, exploit bugs, or reverse-engineer the platform is prohibited and may result in legal action.`,
  },
  {
    title: "Account Suspension",
    content: `Wexora reserves the right to suspend or terminate accounts that violate these Terms, engage in suspicious activity, fail KYC requirements, or are subject to legal orders. In the event of suspension, pending investment returns may be withheld pending investigation. Decisions on suspensions are at Wexora's sole discretion.`,
  },
  {
    title: "Limitation of Liability",
    content: `Wexora operates as an investment platform and is not a licensed financial advisor. All investments carry risk. Wexora shall not be liable for investment losses, system downtime, or losses resulting from factors outside our reasonable control. Our liability is limited to the amount you deposited in the six months preceding any claim.`,
  },
  {
    title: "Changes to Terms",
    content: `We may update these Terms at any time. Significant changes will be communicated via platform announcements or email. Your continued use of Wexora after changes take effect constitutes acceptance of the updated Terms. If you disagree with any changes, you should stop using the platform and contact support to close your account.`,
  },
  {
